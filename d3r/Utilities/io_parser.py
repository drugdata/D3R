...
def print_usage():
    ...
    usage = "usage: blastnfilter --nonpolymertsv --sequencetsv --pdbblastdb --outdir"
    print
    print w.fill(usage)
    print

def interface(args):
    flags = ('--nonpolymertsv', '--sequencetsv', '--pdbblastdb', '--outdir')
...
class ParseArgs:
    def __init__(self, args):
        self.args = args
        self.required = ('--nonpolymertsv', '--sequencetsv', '--pdbblastdb', '--outdir')
